              ...
              {predictionData ? (
                <div className="px-6">
                  ...
                  <Grid container>
                    ...
                    <Grid item>
                      <Typography className="mb-2 "> Rp. {!isNaN(predictionData?.harga_history * 1) ? `${thousandSeparator(predictionData?.harga_history)} - (${predictionData?.harga_history.date})` : predictionData?.harga_history}</Typography>
                    </Grid>
                  </Grid>
                  <Grid container>
                    <Grid item xs={3}>
